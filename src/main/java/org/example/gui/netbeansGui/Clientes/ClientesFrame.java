...
import org.example.gui.netbeansGui.Produtos.*;
...
public class ClientesFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Manipular Clientes:");
        ...
        searchByName.setText("Nome do cliente");
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addComponent(searchByName, javax.swing.GroupLayout.PREFERRED_SIZE, 331, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ClientesCadastro clientesCadastro = new ClientesCadastro();
        ...
        if (row != -1) {
            ...
            String telefone = (jTable1.getModel().getValueAt(row, 2).toString());
            ...
            clientesCadastro = new ClientesCadastro(cpf, nome, telefone, email);
        }

        clientesCadastro.setVisible(true);
        clientesCadastro.pack();
        clientesCadastro.setLocationRelativeTo(null);
        this.dispose();
    ...
    private void searchByNameKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchByNameKeyReleased
        ...
        if (searchByName.getText().equals("")) {
            clientes = interactions.visualizarClientes();
        } else {
            clientes = interactions.visualizarClientesPorNome(searchByName.getText());
        }
    ...
    private void searchByNameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_searchByNameFocusGained
        if (searchByName.getText().equals("Nome do cliente")) {
    ...
    public void addRowToJTable() {
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        List<Clientes> clientes = interactions.visualizarClientes();
